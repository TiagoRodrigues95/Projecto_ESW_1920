...
namespace CandidaturaEmais.Controllers
{
    public class HorasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("HoraId,HoraInicio,HoraFim,DocenteId")] Hora hora)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("HoraId,HoraInicio,HoraFim,DocenteId")] Hora hora)
        {
            if (id != hora.HoraId)
            {
                return NotFound();
